...
button.addEventListener('click',()=>{
   txt = textbox.value
   document.getElementById("output").innerHTML = txt + " has been offered in " + thing(txt) + " of the 10 most recent semesters.<br>These are the semesters this class was offered in:";
   thing(txt)
})